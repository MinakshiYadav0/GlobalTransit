...
public class Login extends javax.swing.JFrame {
    ...
    private void login(){
        try{
           ...
           //Jdbc Code:
           ResultSet rs=db.DbConnect.st.executeQuery("select * from login where id='"+s1+"' and password='"+s1+"'");
           if(rs.next()){
              Home h= new Home();
              ...
              dispose();
               ...
               JOptionPane.showMessageDialog(null, "Wrong Crendential!");
           }
        }catch(Exception ex){
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/extrafiles/Globaltransit.png.png"))); // NOI18N
